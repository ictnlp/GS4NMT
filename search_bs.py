...
class NBS(Func):
    ...
    def beam_search_comb(self, s_tensor):
        ...
        self.decoder.attention.init(enc_src0)
        h0 = self.decoder.attention.h   # (1, aln)
        # s_init: 1x512
        ...
        for i in range(1, self.maxlen + 1):
            ...
            self.decoder.attention.h = h0.expand(preb_sz, align_size)
            ...
            logit = self.decoder.logit(s_i, y_im1, a_i)
